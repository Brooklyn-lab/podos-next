...
export interface Config {
  ...
  fallbackLocale: ('false' | 'none' | 'null') | false | null | ('pl' | 'ua') | ('pl' | 'ua')[]
  globals: {
...
export interface Media {
  id: number
  /**
   * Subfolder name (e.g. certificates, services). Leave empty for root /media/.
   */
  folder?: string | null
  alt: string
  updatedAt: string
...
export interface Work {
  ...
  works?:
    | {
        image: number | Media
        /**
         * Optional. Defaults to "Praca podologiczna" if left empty.
         */
        imageAlt?: string | null
        id?: string | null
      }[]
...
export interface Setting {
  ...
  mapEmbedUrl: string
  /**
   * Clickable link that opens in Google Maps
   */
  mapLinkUrl: string
  mapIcon?: (number | null) | Media
  addressTitle: string
  address: string
